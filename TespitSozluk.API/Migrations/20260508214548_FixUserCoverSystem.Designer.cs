...
namespace TespitSozluk.API.Migrations
{
    ...
    [Migration("20260508214548_FixUserCoverSystem")]
    partial class FixUserCoverSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TespitSozluk.API.Entities.EntryBadge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EntryId", "GiverUserId", "BadgeType")
                        .IsUnique();

                    b.HasIndex("GiverUserId", "BadgeType", "AssignedAt");

                    b.ToTable("EntryBadges");
                });
            ...
            modelBuilder.Entity("TespitSozluk.API.Entities.TopicBlock", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TespitSozluk.API.Entities.User", b =>
                {
                    ...
                    b.Property<string>("CoverChoiceKey")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
            ...
            modelBuilder.Entity("TespitSozluk.API.Entities.UserBlock", b =>
                {
            ...
            modelBuilder.Entity("TespitSozluk.API.Entities.EntryBadge", b =>
                {
                    ...
                    b.HasOne("TespitSozluk.API.Entities.User", "Giver")
                        .WithMany()
            ...
            modelBuilder.Entity("TespitSozluk.API.Entities.UserBlock", b =>
                {
                    b.HasOne("TespitSozluk.API.Entities.User", "Blocked")
                        .WithMany()
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TespitSozluk.API.Entities.User", "Blocker")
                        .WithMany()
